...
public class ListsFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mTabIcons[TAB_INDEX_SPEED_DIAL] = R.drawable.tab_speed_dial;//快速拨号
        mTabIcons[TAB_INDEX_RECENTS] = R.drawable.tab_recents;//最近童话记录
        mTabIcons[TAB_INDEX_ALL_CONTACTS] = R.drawable.tab_contacts;//联系人
        mTabIcons[TAB_INDEX_VOICEMAIL] = R.drawable.tab_voicemail;//语音信箱
